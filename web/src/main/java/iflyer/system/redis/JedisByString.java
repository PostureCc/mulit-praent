...
public class JedisByString {
    ...
    public String get(String key) {
        ...
        Jedis sjedis = JedisByPool.getJedis();
        String value = sjedis.get(key);
        JedisByPool.returnJedis(sjedis);
        return value;
    }
    ...
    public String setEx(String key, int seconds, String value) {
        Jedis jedis = JedisByPool.getJedis();
        String str = jedis.setex(key, seconds, value);
        JedisByPool.returnJedis(jedis);
        return str;
    }
